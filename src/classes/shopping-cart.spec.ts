...
describe('ShoppingCart', () => {
  ...
  it('should call discount.calculate once when totalWothDiscount is called', () => {
  ...
  it('should call discount.calculate with totalPrice when totalWothDiscount is called', () => {
    const { sut, discountMock } = createSutWithProducts();
    const discountMockSpy = jest.spyOn(discountMock, 'calculate');
    sut.totalWithDiscount();
